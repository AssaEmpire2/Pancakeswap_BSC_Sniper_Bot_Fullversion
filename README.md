# 🚀 Pancakeswap BSC Sniper Bot Fullversion 🚀
...
Clone Repo:  
```shell
git clone https://github.com/SavannahCatToken/Pancakeswap_BSC_Sniper_Bot_Fullversion
...
python Sniper.py -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff -a 0.001 -tx 2 -hp  -wb 10 -tp 50
python Sniper.py -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff --sellonly
python Sniper.py -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff -a 0.001 --buyonly
python Sniper.py -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff -tsl 10 -nb
```  

Here are all options with infos:  
```python3
*'-t' or '--token', Token for snipe e.g. "-t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff"
